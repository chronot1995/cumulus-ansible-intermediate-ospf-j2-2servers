...
#    using topology data from: int-ansible-training-ospf-j2-2servers.dot
...
REPOSITORY="https://github.com/CumulusNetworks/int-ansible-training-ospf-j2-2servers"
REPONAME="int-ansible-training-ospf-j2-2servers"
