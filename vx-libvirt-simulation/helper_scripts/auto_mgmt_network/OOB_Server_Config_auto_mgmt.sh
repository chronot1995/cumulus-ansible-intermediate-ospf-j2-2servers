...
#    using topology data from: cumulus-ansible-intermediate-ospf-j2-2servers.dot
...
REPOSITORY="https://github.com/CumulusNetworks/cumulus-ansible-intermediate-ospf-j2-2servers"
REPONAME="cumulus-ansible-intermediate-ospf-j2-2servers"
